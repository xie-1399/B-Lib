/*
    ...
    Filename:      S55NLLG2PH_X32Y1D92.v
    IP code :      S55NLLG2PH
    Version:       1.1.b
    ...
    Configuration: -instname S55NLLG2PH_X32Y1D92 -rows 32 -bits 92 -mux 1
    Redundancy: Off
    Bit-Write: Off
*/
...
(CENA_latched!==1'b1);
  ...
  specify
    ...
    (posedge CLKA => (QA[64] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[65] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[66] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[67] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[68] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[69] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[70] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[71] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[72] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[73] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[74] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[75] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[76] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[77] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[78] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[79] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[80] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[81] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[82] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[83] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[84] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[85] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[86] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[87] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[88] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[89] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[90] : 1'bx))=(1.000,1.000);
    (posedge CLKA => (QA[91] : 1'bx))=(1.000,1.000);
    ...
    $period(posedge CLKA,1.244,CLKA_CYC_flag);
    $width(posedge CLKA,0.373,0,CLKA_H_flag);
    $width(negedge CLKA,0.373,0,CLKA_L_flag);

    $setuphold(posedge CLKB,posedge CENB,0.500,0.250,CENB_flag);
    $setuphold(posedge CLKB,negedge CENB,0.500,0.250,CENB_flag);
    $period(posedge CLKB,1.244,CLKB_CYC_flag);
    $width(posedge CLKB,0.373,0,CLKB_H_flag);
    $width(negedge CLKB,0.373,0,CLKB_L_flag);
    ...
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[64],0.500,0.250,DB64_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[64],0.500,0.250,DB64_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[65],0.500,0.250,DB65_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[65],0.500,0.250,DB65_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[66],0.500,0.250,DB66_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[66],0.500,0.250,DB66_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[67],0.500,0.250,DB67_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[67],0.500,0.250,DB67_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[68],0.500,0.250,DB68_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[68],0.500,0.250,DB68_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[69],0.500,0.250,DB69_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[69],0.500,0.250,DB69_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[70],0.500,0.250,DB70_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[70],0.500,0.250,DB70_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[71],0.500,0.250,DB71_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[71],0.500,0.250,DB71_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[72],0.500,0.250,DB72_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[72],0.500,0.250,DB72_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[73],0.500,0.250,DB73_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[73],0.500,0.250,DB73_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[74],0.500,0.250,DB74_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[74],0.500,0.250,DB74_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[75],0.500,0.250,DB75_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[75],0.500,0.250,DB75_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[76],0.500,0.250,DB76_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[76],0.500,0.250,DB76_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[77],0.500,0.250,DB77_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[77],0.500,0.250,DB77_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[78],0.500,0.250,DB78_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[78],0.500,0.250,DB78_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[79],0.500,0.250,DB79_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[79],0.500,0.250,DB79_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[80],0.500,0.250,DB80_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[80],0.500,0.250,DB80_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[81],0.500,0.250,DB81_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[81],0.500,0.250,DB81_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[82],0.500,0.250,DB82_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[82],0.500,0.250,DB82_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[83],0.500,0.250,DB83_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[83],0.500,0.250,DB83_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[84],0.500,0.250,DB84_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[84],0.500,0.250,DB84_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[85],0.500,0.250,DB85_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[85],0.500,0.250,DB85_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[86],0.500,0.250,DB86_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[86],0.500,0.250,DB86_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[87],0.500,0.250,DB87_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[87],0.500,0.250,DB87_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[88],0.500,0.250,DB88_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[88],0.500,0.250,DB88_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[89],0.500,0.250,DB89_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[89],0.500,0.250,DB89_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[90],0.500,0.250,DB90_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[90],0.500,0.250,DB90_flag);
    $setuphold(posedge CLKB &&& CEB_flag,posedge DB[91],0.500,0.250,DB91_flag);
    $setuphold(posedge CLKB &&& CEB_flag,negedge DB[91],0.500,0.250,DB91_flag);
  endspecify
